...
* $$\color{red}{\text{Step-1: The Set-up}}$$
  ...
  | 5. <code>ls</code> | ![View](https://github.com/thechiragvaishnav-dotcom/Python-Network-Port-Scanner/issues/6#issue-3943861328) | Here, you should see $$\color{white}{\text{portscan.py}}$$(file) not same color as other $$\color{blue}{\text{directories}}$$ |
